...
import { dailyBiteLogo } from "../assets/index.js";
...
const Footer = () => {
    ...
    return (
        <footer className="bg-[var(--light-bg)] py-12 md:py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-6">
                    ...
                    <div className="order-4 text-center sm:text-left sm:order-4 lg:order-0 lg:col-span-2 sm:col-span-2">
                            ...
                            <div className="flex space-x-4 mt-6">
                                {[
                                    ...
                                    <a
                                        key={label}
                                        href="#"
                                        className="w-6 h-6 text-[var(--text-muted)] hover:text-[var(--primary-color)] transition-colors duration-300"
                        ...
                        <p className="text-sm text-[var(--text-muted)] leading-relaxed">
                            Copyright © 2025 by DailyBite, Inc. All rights
                            reserved.
                        </p>
                    </div>
                        ...
                        <div
                                ...
                                <ul className="space-y-3">
                                    {section.links.map((link, linkIndex) => (
                                        <li key={linkIndex}>
                                            <a
                                                href={link.href}
                                                className="text-base text-[var(--text-muted)] hover:text-[var(--primary-color)] transition-colors duration-300">
                                                {link.name}
                                            </a>
                                        </li>
                                    ))}
                            ...
                            {section.type === "contact" && (
                                <div className="space-y-4">
                                    <address className="text-base text-[var(--text-muted)] leading-relaxed not-italic">
                                        {section.content.address}
                                    </address>
                                    <div className="space-y-2">
                                        <a
                                            href={`tel:${section.content.phone}`}
                                            className="block text-sm text-[var(--text-muted)] hover:text-[var(--primary-color)] transition-colors duration-300">
