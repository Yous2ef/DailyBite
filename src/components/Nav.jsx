    ...
    return (
        <nav
            className={`flex fixed left-0 right-0 items-center z-10 justify-between px-6 py-4 md:px-11 ${
                showNavbar ? "bg-[var(--white)]" : "bg-transparent"
            }`}>
            {/* Logo */}
            <a className="flex items-center cursor-pointer" href="#home">
                <img src={dailyBiteLogo} alt="DailyBite" className="h-14" />
            </a>
            ...
            <div className="md:hidden">
                <button
                    ...
                    className="text-gray-800 hover:text-[var(--primary-color)] p-2">
                    <svg
                        className="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
            ...
            {isMenuOpen && (
                <div className="fixed h-screen top-18 left-0 right-0 bg-[var(--white)] shadow-lg md:hidden z-50">
