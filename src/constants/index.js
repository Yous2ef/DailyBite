...
const steps = [
    {
        ...
        description:
            "Never again waste time thinking about what to eat! DailyBite AI will create a 100% personalized weekly meal plan just for you. It makes sure you get all the nutrients and vitamins you need, no matter what diet you follow!",
        image: appScreen1,
    },
    {
        number: "02",
        ...
        description:
            "Once per week, approve the meal plan generated for you by DailyBite AI. You can change ingredients, swap entire meals, or even add your own recipes.",
        image: appScreen2,
    },
    {
        number: "03",
...
const testimonials = [
    ...
    },
    {
        id: 3,
        name: "Steve Miller",
        text: "DailyBite is a life saver! I just started a company, so there's no time for cooking. I couldn't live without my daily meals now!",
        image: steve,
    },
    {
        id: 4,
        name: "Hannah Smith",
        text: "I got DailyBite for the whole family, and it frees up so much time! Plus, everything is organic and vegan and without plastic.",
        image: hannah,
    },
];
