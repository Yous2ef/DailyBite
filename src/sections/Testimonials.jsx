        ...
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="space-y-12">
                    <div>
                        <p className="text-[var(--primary-color)] font-semibold text-base tracking-[0.75px] uppercase mb-4">
                            Testimonials
                        </p>
                        <h2 className="text-3xl md:text-4xl lg:text-[44px] font-bold text-[var(--color-black)] leading-tight">
                    ...
                    <div className="space-y-12 sm:grid grid-cols-2 gap-12">
                        {testimonials.map((testimonial) => (
                            <div
                                ...
                                <blockquote className="text-base text-center max-w-2xl sm:text-left leading-10 text-[var(--text-secondary)] font-medium">
                                    "{testimonial.text}"
                                </blockquote>
                                <p className="text-base  text-center sm:text-left text-[var(--text-light)] font-medium">
